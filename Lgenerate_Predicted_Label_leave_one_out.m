...
for i=1:size(data_set,1)
    ...
    if strcmp(para.feature_selection_mode,'cross-validation')
        ...
        [resultACC,resultAUC,result_feat_ranked,result_feat_scores,result_feat_idx_ranked]=Leveluate_feat_using_diff_classifier_feature_selection(training_set,training_labels,para.feature_list,para);
